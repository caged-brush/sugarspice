  ...
  return (
    <>
      ...
      <img
        ...
        alt="About Us"
        className="rounded-4xl w-96 h-96"
      />
      <div className="p-6 mr-32 ml-32 lg:px-8">
        ...
        <p className="mt-4 font-thin text-2xl text-gray-400">
          ...
          uplifting atmosphere, we guarantee you'll enjoy your time with us.
        </p>
        ...
        <ul className="list-disc ml-6 mt-4">
          <li className="flex flex-row">
            ...
            <p>
              ...
              communication,respect,integrity and an understanding that together
              we can achieve more,benefiting all employees,business partners and
              clients.
            </p>
          </li>
